...
def get_tile(filename, coord):
    ...
    formats = {'png': 'image/png', 'jpg': 'image/jpeg', 'json': 'application/json',
               'pbf': 'application/x-protobuf', None: None}
...
class Provider:
    ...
    def renderTile(self, width, height, srs, coord):
        ...
        formats = {'image/png': 'PNG', 'image/jpeg': 'JPEG', 'application/json': 'JSON',
                   'application/x-protobuf': 'PBF', None: None}
    ...
    def getTypeByExtension(self, extension):
        ...
        if extension.lower() == 'json':
            ...
            raise KnownUnknown('MBTiles only makes .png and .jpg and .json tiles, ',
